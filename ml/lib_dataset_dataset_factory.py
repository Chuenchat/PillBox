#@title lib_dataset_dataset_factory.py

import lib_dataset_voc as voc
import lib_dataset_pills as pills
import lib_dataset_circles as circles
import lib_dataset_shape2d as shape2d
import lib_dataset_shape3d as shape3d

dataset_map = {
                'voc': voc.VOCDetection,
                'pills': pills.PillsDetection,
                'circles': circles.CircleDetection,
                'shape2d': shape2d.Shape2DDetection,
                'shape3d': shape3d.Shape3DDetection,
            }
